...
// pub const ORDER_CANCEL_BY_ID: &str = &format!("{API_V1}/{id}/cancel");
// pub const ORDER_CONFIRM_BY_ID: &str = &format!("{API_V1}/{id}/confirm");
// pub const ORDER_GET_BY_ID: &str = &format!("{API_V1}/{id}");
pub const ORDER_GET_ALL: &str = formatcp!("{API_V1}/");
// pub const ORDER_GET_WITH_PAGINATION: &str = &format!("{API_V1}/?startId={startId}&limit={limit}");
